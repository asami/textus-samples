...
This is the advanced, direct-framework companion to `05.a-job-control-lab`.
...
`05.a-job-control-lab` is the builtin-component sample.

`05.b-job-control-demo-lab` is the direct framework demo:
