...
final class BundledcompComponent extends Component {
  override def subsystemDefinitionRecords: Vector[Record] =
    Vector(Record.data("name" -> "testsubsystemmixed"))
}

object BundledcompComponent extends Component.Factory {
...
final case class HelloActionCall(
  ...
  override def execute(): Consequence[OperationResponse] =
    response_string("Hello from bundledcomp in testsubsystemmixed")
}
