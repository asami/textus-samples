...
```bash
cncf dev command --project-dev . admin.assembly.warnings --format yaml --no-default-components --component-dir <temporary-component-dir> --textus.subsystem=testsubsystemmixed
```
