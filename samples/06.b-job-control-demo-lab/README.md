...
`06.b-job-control-demo-lab` is the internal-proof companion to `06.a-job-control-lab`.
...
- `06.b-job-control-demo-lab` explains where the lower-level direct-framework proof now lives
...
```bash
$ cd samples/06.b-job-control-demo-lab
$ ../../bin/setup cozy
```
