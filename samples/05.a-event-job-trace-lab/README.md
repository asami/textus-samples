...
This is the bridge lab between `05-event-driven` and `06-job`.
...
- `05-event-driven` focuses on event emission and visible post-event effect
- `05.a-event-job-trace-lab` focuses on tracing the same reaction through job/history/event observation
