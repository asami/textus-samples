...
final class SubsystemSampleComponent extends Component

object SubsystemSampleComponent extends Component.Factory {
  val name = "subsystem"
...
final case class HelloActionCall(
  ...
  override def execute(): Consequence[OperationResponse] =
    response_string("Hello from the minimum subsystem")
}
