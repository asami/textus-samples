package org.sample.crud.entity.create
...
case class Item(override val id: Option[EntityId], nameAttributes: NameAttributes, descriptiveAttributes: DescriptiveAttributes, lifecycleAttributes: LifecycleAttributes, publicationAttributes: PublicationAttributes, securityAttributes: SecurityAttributes, resourceAttributes: ResourceAttributes, auditAttributes: AuditAttributes, mediaAttributes: MediaAttributes, contextualAttribute: ContextualAttributes) extends org.simplemodeling.model.SimpleEntityCreate with EntityPersistableCreate{
  import Item.*
  override def name_Attributes: NameAttributes = nameAttributes
  override def descriptive_Attributes: DescriptiveAttributes = descriptiveAttributes
  override def lifecycle_Attributes: LifecycleAttributes = lifecycleAttributes
  override def publication_Attributes: PublicationAttributes = publicationAttributes
  override def security_Attributes: SecurityAttributes = securityAttributes
  override def resource_Attributes: ResourceAttributes = resourceAttributes
  override def audit_Attributes: AuditAttributes = auditAttributes
  override def media_Attributes: MediaAttributes = mediaAttributes
  override def contextual_Attribute: ContextualAttributes = contextualAttribute
  ...
  def withId(id: Option[EntityId]): Item = {
    copy(id = id)
  }
...
object Item {
  ...
  given EntityPersistentCreate[Item] with
    def id(e: Item): Option[EntityId] = e.id
  ...
  case class Builder(id: Option[EntityId] = None, name_Attributes: Option[NameAttributes] = None, descriptive_Attributes: Option[DescriptiveAttributes] = None, lifecycle_Attributes: Option[LifecycleAttributes] = None, publication_Attributes: Option[PublicationAttributes] = None, security_Attributes: Option[SecurityAttributes] = None, resource_Attributes: Option[ResourceAttributes] = None, audit_Attributes: Option[AuditAttributes] = None, media_Attributes: Option[MediaAttributes] = None, contextual_Attribute: Option[ContextualAttributes] = None, _failures: Vector[Consequence.Failure[_]] = Vector.empty) {
    ...
    def buildCWithExecutionContext(using ctx: org.goldenport.cncf.context.ExecutionContext): Consequence[Item] = {
      (
        Consequence.success(id),
        Consequence.success(name_Attributes.getOrElse(org.simplemodeling.model.value.NameAttributes.simple(Name("unknown")))),
        Consequence.success(descriptive_Attributes.getOrElse(org.simplemodeling.model.value.DescriptiveAttributes.empty)),
    ...
    def buildC(record: Record): Consequence[Item] = {
      (
        _record_get_as_c[EntityId](record, INPUT_KEYS_ID).map(_  orElse id), 
        (
    ...
    def buildCWithExecutionContext(record: Record)(using ctx: org.goldenport.cncf.context.ExecutionContext): Consequence[Item] = {
      (
        _record_get_as_c[EntityId](record, INPUT_KEYS_ID).map(_  orElse id), 
        (
          _record_get_as_c[Name](record, List("name")),
  ...
  def createWithExecutionContextC(name_Attributes: NameAttributes, descriptive_Attributes: DescriptiveAttributes, lifecycle_Attributes: LifecycleAttributes, publication_Attributes: PublicationAttributes, security_Attributes: SecurityAttributes, resource_Attributes: ResourceAttributes, audit_Attributes: AuditAttributes, media_Attributes: MediaAttributes, contextual_Attribute: ContextualAttributes)(using ctx: org.goldenport.cncf.context.ExecutionContext): Consequence[Item] = {
    val builder = Builder()
    val builder2 = builder.withName_Attributes(name_Attributes).withDescriptive_Attributes(descriptive_Attributes).withLifecycle_Attributes(lifecycle_Attributes).withPublication_Attributes(publication_Attributes).withSecurity_Attributes(security_Attributes).withResource_Attributes(resource_Attributes).withAudit_Attributes(audit_Attributes).withMedia_Attributes(media_Attributes).withContextual_Attribute(contextual_Attribute)
    builder2.buildCWithExecutionContext
  }
 
  def create(name_Attributes: NameAttributes, descriptive_Attributes: DescriptiveAttributes, lifecycle_Attributes: LifecycleAttributes, publication_Attributes: PublicationAttributes, security_Attributes: SecurityAttributes, resource_Attributes: ResourceAttributes, audit_Attributes: AuditAttributes, media_Attributes: MediaAttributes, contextual_Attribute: ContextualAttributes): Item = {
  ...
  def createWithExecutionContext(name_Attributes: NameAttributes, descriptive_Attributes: DescriptiveAttributes, lifecycle_Attributes: LifecycleAttributes, publication_Attributes: PublicationAttributes, security_Attributes: SecurityAttributes, resource_Attributes: ResourceAttributes, audit_Attributes: AuditAttributes, media_Attributes: MediaAttributes, contextual_Attribute: ContextualAttributes)(using ctx: org.goldenport.cncf.context.ExecutionContext): Item = {
    createWithExecutionContextC(name_Attributes, descriptive_Attributes, lifecycle_Attributes, publication_Attributes, security_Attributes, resource_Attributes, audit_Attributes, media_Attributes, contextual_Attribute).take
  }
  ...
  def createWithExecutionContextC(record: Record)(using ctx: org.goldenport.cncf.context.ExecutionContext): Consequence[Item] = {
    val builder = Builder()
    builder.buildCWithExecutionContext(record)
  }
  ...
  def createWithExecutionContext(record: Record)(using ctx: org.goldenport.cncf.context.ExecutionContext): Item = {
    createWithExecutionContextC(record).take
  }
}
