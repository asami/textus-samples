...
```bash
cncf dev command --project . admin.assembly.report --format yaml --component-dir <temporary-component-dir> --textus.subsystem=testsubsystemwiring --textus.subsystem.file=<temporary-subsystem-sar>
```
...
```bash
cncf dev command --project . admin.assembly.descriptor --format yaml --component-dir <temporary-component-dir> --textus.subsystem=testsubsystemwiring --textus.subsystem.file=<temporary-subsystem-sar>
```
...
```bash
cncf dev command --project . admin.assembly.diagram --component-dir <temporary-component-dir> --textus.subsystem=testsubsystemwiring --textus.subsystem.file=<temporary-subsystem-sar>
```
