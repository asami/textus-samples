...
Deliver the first minimal event-oriented sample after `04-cqrs`.
...
- [x] `samples/05-event-driven/README.md` explains the event, the receiver, and the observable effect
