# 03.b-test-sync-command-lab Development Instruction

Status: `Active Instruction`

This is the active development work-order document for `03.b-test-sync-command-lab`.
...
Use `03-cqrs` as the base.

The command target should remain the same command-style target as in `03-cqrs`.
