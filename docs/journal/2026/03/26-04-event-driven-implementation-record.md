# 04-event-driven Implementation Record
...
`04-event-driven` is now a pure model-driven sample.
...
- `samples/04-event-driven/src/main/cozy/event.cml`
- `samples/04-event-driven/src/main/scala/org/sample/eventdriven/EventFlowDemo.scala`
- `samples/04-event-driven/run.sh`
- `samples/04-event-driven/run-demo.sh`
- `samples/04-event-driven/README.md`
