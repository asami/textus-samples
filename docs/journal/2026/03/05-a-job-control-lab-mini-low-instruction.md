# 05.a-job-control-lab Mini-Low Instruction

Read first:

- /Users/asami/src/dev2026/cncf-samples/docs/journal/2026/03/05-a-job-control-lab-development-instruction.md
- /Users/asami/src/dev2026/cncf-samples/docs/phase/samples/05.a-job-control-lab.md
- /Users/asami/src/dev2026/cncf-samples/samples/05-job/README.md
- /Users/asami/src/dev2026/cncf-samples/docs/phase/samples/05-job.md

## Goal

Implement the first minimal `05.a-job-control-lab`.
...
Prefer the same direction as `05-job`:
...
- `/Users/asami/src/dev2026/cncf-samples/samples/05.a-job-control-lab/README.md`
- `/Users/asami/src/dev2026/cncf-samples/docs/phase/samples/05.a-job-control-lab.md`
...
Do not mark `05.a-job-control-lab` as `DONE` unless cancel, suspend, resume, and observation are all actually confirmed.
