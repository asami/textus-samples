# 03-cqrs Development Instruction

Status: `Active Instruction`

This is the active development work-order document for `03-cqrs`.
...
Build `03-cqrs` as the first sample that makes command and query responsibilities visibly different.
...
Keep `03-cqrs` deliberately narrow.
...
`03-cqrs` must show a clear split between:
...
`03-cqrs` should build directly on the lessons of:
...
But `03-cqrs` must add a new point:
...
- [`docs/phase/samples/03-cqrs.md`](/Users/asami/src/dev2026/cncf-samples/docs/phase/samples/03-cqrs.md)
- the actual sample implementation files under [`samples/03-cqrs`](/Users/asami/src/dev2026/cncf-samples/samples/03-cqrs)
...
- [`docs/phase/samples/03-cqrs.md`](/Users/asami/src/dev2026/cncf-samples/docs/phase/samples/03-cqrs.md) is updated honestly
