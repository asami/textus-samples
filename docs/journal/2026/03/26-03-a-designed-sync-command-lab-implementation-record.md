# 03.a-designed-sync-command-lab Implementation Record

Status: `Completed`

## Summary

`03.a-designed-sync-command-lab` demonstrates a command that returns its
result immediately by design through CML operation metadata.

## Facts

- The sample lives under `samples/03.a-designed-sync-command-lab`.
...
- The README was updated to explain why this is design-time sync and how it differs from `03-cqrs`.
