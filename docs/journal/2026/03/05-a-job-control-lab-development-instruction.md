# 05.a-job-control-lab Development Instruction

## Goal

Create the first dedicated lab for CNCF job control after `05-job`.
...
- use the same model-driven direction as `05-job` when possible
...
- how this differs from `05-job`
- how this differs from the lower-level framework-facing demo lab

## Checklist Direction

Use a separate phase checklist for `05.a-job-control-lab`.

Do not expand `05-job` itself beyond its current completion line.
