...
- [`docs/journal/2026/03/03-cqrs-development-instruction.md`](/Users/asami/src/dev2026/cncf-samples/docs/journal/2026/03/03-cqrs-development-instruction.md)
- [`docs/phase/samples/03-cqrs.md`](/Users/asami/src/dev2026/cncf-samples/docs/phase/samples/03-cqrs.md)
...
Implement `03-cqrs` as the first sample that clearly separates:
...
2. inspect the current `samples/03-cqrs` scaffold
...
- Do not turn `03-cqrs` into an event-sourcing sample.
