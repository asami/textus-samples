# 06.a-aggregate-single-record-lab Test Mini Low Instruction

## Goal

Verify the already-implemented `06.a-aggregate-single-record-lab`.
...
`06.a-aggregate-single-record-lab` shows the single-record aggregate pattern:
...
This is different from `06-aggregate`, which shows the application-join aggregate pattern.
...
- `/Users/asami/src/dev2026/cncf-samples/samples/06.a-aggregate-single-record-lab/README.md`
- `/Users/asami/src/dev2026/cncf-samples/docs/phase/samples/06.a-aggregate-single-record-lab.md`
- `/Users/asami/src/dev2026/cncf-samples/docs/journal/2026/03/30-06-a-aggregate-single-record-lab-implementation-record.md`
- `/Users/asami/src/dev2026/cncf-samples/samples/06-aggregate/README.md`
...
`/Users/asami/src/dev2026/cncf-samples/samples/06.a-aggregate-single-record-lab`
