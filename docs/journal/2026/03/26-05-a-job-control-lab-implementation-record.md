# 05.a-job-control-lab Implementation Record

## Summary

Implemented the first minimal job-control lab after `05-job`, with lifecycle event observation and per-job history observation.

## Facts

- The sample directory is [`samples/05.a-job-control-lab`](/Users/asami/src/dev2026/cncf-samples/samples/05.a-job-control-lab).
- The model source is [`samples/05.a-job-control-lab/src/main/cozy/job-control-lab.cml`](/Users/asami/src/dev2026/cncf-samples/samples/05.a-job-control-lab/src/main/cozy/job-control-lab.cml).
- The demo runner is [`samples/05.a-job-control-lab/src/main/scala/org/sample/jobcontrol/JobControlDemo.scala`](/Users/asami/src/dev2026/cncf-samples/samples/05.a-job-control-lab/src/main/scala/org/sample/jobcontrol/JobControlDemo.scala).
- The demo route is `bash run.sh` in [`samples/05.a-job-control-lab`](/Users/asami/src/dev2026/cncf-samples/samples/05.a-job-control-lab/README.md).
