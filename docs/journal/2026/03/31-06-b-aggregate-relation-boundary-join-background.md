...
This note records why `06.b-aggregate-relation-boundary-model` was introduced.
...
`06-aggregate` shows application-join aggregate assembly.

`06.a-aggregate-single-record-lab` shows a single-record aggregate with
embedded value objects.

`06.b-aggregate-relation-boundary-model` exists to show that aggregate
