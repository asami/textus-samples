# 03.a-designed-sync-command-lab Mini-Low Instruction
...
- [`samples/03-cqrs/src/main/cozy/cqrs.cml`](/Users/asami/src/dev2026/cncf-samples/samples/03-cqrs/src/main/cozy/cqrs.cml)

## Goal

Create `03.a-designed-sync-command-lab` as a follow-up to `03-cqrs`.
...
1. a new sample directory for `03.a-designed-sync-command-lab`
...
- Use the same model-driven Cozy/CML direction as `03-cqrs`.
...
3. copy only the minimum structure needed from `03-cqrs`
