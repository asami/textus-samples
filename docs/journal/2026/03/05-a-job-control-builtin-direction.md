# 05.a-job-control-lab Builtin Direction

## Decision

`05.a-job-control-lab` should be based on a builtin `JobControl` component, not on direct framework API calls from a demo runner.
