# 06.a-aggregate-single-record-lab Mini Low Instruction

## Goal

Polish the documentation around `06.a-aggregate-single-record-lab`.
...
`06-aggregate` shows the application-join aggregate pattern:
...
2. Make the distinction between `06-aggregate` and `06.a-aggregate-single-record-lab` explicit.
