# 02.f CRUD Nested Value Lab Rework Checklist

- [x] Move the sample to the generated `sbt-cozy` CRUD line
- [x] Remove the hand-written nested value demo mains from the sample path
