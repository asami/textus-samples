...
Rework `11-subsystem` as the shell-first baseline formal subsystem sample driven by a generic component artifact and a subsystem-name CLI parameter.
...
- [x] `samples/11-subsystem/README.md` matches the implementation
- [x] build succeeds
